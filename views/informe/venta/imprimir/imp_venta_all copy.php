...
$pdf->Cell(20, 10, '', 0);
$pdf->Cell(15, 10, number_format(($total_igv_gravadas + $total_igv_exoneradas),2),0,0,'R');
$pdf->Ln(9); 
$pdf->Cell(72,0,'','T');  
$pdf->Ln(0);
...
// PIE DE PAGINA
$pdf->Ln(5);
$pdf->Cell(72,0,'DESARROLLADO POR +51960146506',0,1,'C');
$pdf->Ln(4);
$pdf->Cell(72,0,'www.sistemaderestaurant.com',0,1,'C');
$pdf->Ln(5);
$pdf->Cell(72,0,'CONTACTOS WHATSAPP +51960146506',0,1,'C');
$pdf->Ln(10);
