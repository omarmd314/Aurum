...
$logo = 'la_torre_p.png';
 if(strlen($this->empresa['logo']) > 0){ 
	 //$url_logo = URL."public/images/".$this->empresa['logo'];
	 $url_logo = URL."public/images/".$logo;
	 $pdf->Image($url_logo,10,2, 50,40,'PNG');
	#$pdf->Cell(72,4,utf8_decode("factura"),0,1,'C');
	$pdf->Cell(72,30,'',0,1,'C');
} 
...
$pdf->SetFont('Helvetica', 'B', 9);
$pdf->Cell(72,0,utf8_decode('CONDICI脫N DE PAGO: CONTADO'),0,1,'L');
$pdf->Ln(4);
$pdf->Cell(72,0,'','T');
...
$pdf->MultiCell(47,4,utf8_decode('Representaci贸n impresa de la '.$this->dato->desc_td).' '.$elec.' consulte en',0,'C');
