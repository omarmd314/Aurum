...
var listar = function(){
    var vuelta=0;
    alert('Kardex entro 001 entra para cargar la pagina y buscar el producto'); // entra para cargar la pagina informe/inventario_kardex
    tipo_ip = $("#tipo_ip").val();
    id_ip = $("#id_ip").val();
    ifecha = $("#start").val();
    ffecha = $("#end").val();
            ...
            if (item.data.length != 0) {
                ...
                $.each(item.data, function(i, campo) {
                    if(campo.estado == 'a'){
                        ...
                        console.log('stock_entradas = '+stock_entradas)
                        stock_salidas += parseFloat(campo.cantidad_salida);
                        console.log('stock_salidas = '+stock_salidas);                     
                        stock_final =stock_entradas-stock_salidas;
                        console.log('stock_final = '+stock_final);
                    }
                });
    ...
    var cante = 0,
        ...
        .DataTable({
          ...
                }},
                {"data": null,"render": function ( data, type, row ) {
                   
                   // console.log("data.cant es abjo::::")
                    //console.log(data.cant);
                    //console.log("data.id_tipo_ope = "+data.id_tipo_ope);
                  ...
                  //  console.log("data.estado = "+data.estado);
                    if(data.estado == 'a'){
                        ...
                        cantt = (ent-sal) + cantt;
                       // console.log("sal(1) = "+sal);
                        return '<div class="text-info text-center">'+(cantt).toFixed(6)+'</div>';
                    } else {
                        //console.log("sal(2) = "+(stock_inicial + cantt));
