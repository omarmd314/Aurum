...
$resp = $procesarcomprobante->procesar_resumen_boletas($array_emisor, $array_cabecera, $array_detalle, $rutas);
$resp['ruta_xml'] = 'archivos_xml_sunat/cpe_xml/beta/' . $array_emisor['ruc'] . '/' . $nombre_archivo . '.XML';
$resp['ruta_cdr'] = 'archivos_xml_sunat/cpe_xml/beta/' . $array_emisor['ruc'] . '/R-' . $nombre_archivo . '.XML';
$resp['ruta_pdf'] = 'archivos_xml_sunat/cpe_xml/beta/' . $array_emisor['ruc'] . '/' . $nombre_archivo . '.pdf';
$resp['url_xml'] = 'archivos_xml_sunat/cpe_xml/beta/' . $array_emisor['ruc'] . '/' . $nombre_archivo . '.XML';
